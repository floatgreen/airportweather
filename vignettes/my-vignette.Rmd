...
An unusual case is that when the user run functions exactly at the time of observation time, then the html will show one data point less than the normal cases, so is the rerurned dataframe.
